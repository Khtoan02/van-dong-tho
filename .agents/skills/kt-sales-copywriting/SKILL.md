---
name: kt-sales-copywriting
description: Use when writing sale pages or landing page copy.
---
...
| Dịch vụ giá cao, tư vấn, coaching 1-1, chương trình doanh nghiệp | `references/dich-vu-gia-cao.md` (12 section, không niêm yết giá - thay bằng Form đăng ký tư vấn) |

Nếu không rõ, hỏi ngắn gọn: sản phẩm là khoá học/sản phẩm số hay dịch vụ giá cao, và giá có công khai trên trang không.
...
Mặc định trả nội dung trong **file markdown** (`.md`) đặt tại output path của dự án/client để Project Lead dễ quản lý - sale page thường dài 1500-3000 chữ, đọc trong chat rất khó thao tác.
