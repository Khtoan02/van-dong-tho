---
name: kt-crm-integration
description: Connect HTML forms to HighLevel External Tracking.
version: 0.1.0
...
metadata:
  antigravity:
    tags: [agency, crm, gohighlevel, external-tracking, forms]
    related_skills: []
---
...
1. Chọn một identifier ASCII cố định, ví dụ `lp-kiep-nao-order-v1`.
...
- Số điện thoại nên test ở dạng quốc tế, ví dụ `+84901234567`.
